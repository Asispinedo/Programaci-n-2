...
public class vIntroducirEntrenadores extends JFrame 
{
	 ...
	 * Create the frame.
	 */
	public vIntroducirEntrenadores(clsGestor _objGestor) 
	{
		objGestor = _objGestor;
		setBackground(Color.CYAN);
		setTitle("INTRODUCIR ENTRENADORES");
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Industria 4.0\\Dropbox\\TKNS\\IconoEntrenador.jpg"));
		...
		JComboBox cmbpuesto = new JComboBox();
		cmbpuesto.setModel(new DefaultComboBoxModel(new String[] {"PRIMER ENTRENADOR", "SEGUNDO ENTRENADOR", "TERCER ENTRENADOR", "PREPARADOR FISICO", "NUTRICIONISTA"}));
		cmbpuesto.setBounds(267, 44, 124, 20);
		...
		JLabel lblPosicion = new JLabel("PUESTO\r\n");
		...
		btnenviarjugador.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) 
			{
				try 
				{
					objGestor.introducirEntrenadores(txtnombre.getText(),txtapellido.getText(), Integer.parseInt(txtañonacimiento.getText()), cmbpuesto.getSelectedItem().toString(), Integer.parseInt(txtid.getText()));
