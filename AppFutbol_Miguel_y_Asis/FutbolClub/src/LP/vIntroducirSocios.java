...
public class vIntroducirSocios extends JFrame {
	 ...
	 * Create the frame.
	 */
	public vIntroducirSocios(clsGestor _objGestor) {
		objGestor = _objGestor;
		setBackground(Color.CYAN);
		setTitle("INTRODUCIR SOCIOS");
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Industria 4.0\\Desktop\\TKNS\\AppFutbol_Miguel_y_Asis\\IconoSocio.jpg"));
		...
		lblId.setBounds(268, 26, 46, 14);
		contentPane.add(lblId);
		
		JLabel lblPosicion = new JLabel("NUMERO DE SOCIO");
		lblPosicion.setFont(new Font("Tahoma", Font.BOLD, 11));
		lblPosicion.setBounds(141, 75, 113, 14);
		...
		txtnumerosocio.setBounds(265, 44, 88, 20);
		contentPane.add(txtnumerosocio);
		...
		btnenviarjugador.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
				objGestor.introducirSocios(txtnombre.getText(), txtapellido.getText(), Integer.parseInt(txtañonacimiento.getText()), Integer.parseInt(txtnumerosocio.getText()), Integer.parseInt(txtid.getText()));
				dispose();
				}catch(Exception exc) {
