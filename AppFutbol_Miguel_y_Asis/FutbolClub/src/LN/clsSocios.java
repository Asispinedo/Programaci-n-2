...
public class clsSocios extends clsPersonasClub implements Comparable<clsSocios> {
	int numeroSocio;
	...
	@Override
	public int compareTo(clsSocios o) {
Integer compare=(Integer) ((clsSocios)o).getObjectProperty(Constantes.ID);
